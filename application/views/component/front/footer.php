                            ...
                            <ul class="media-content-list">
                                <li>
                                    <div class="media-left">
                                        <img class="img-fluid" src="<?php echo base_url('front_assets/img/art/img1.jpg') ?>" alt="">
                                        <div class="overlay">
                                ...
                                <li>
                                    <div class="media-left">
                                        <img class="img-fluid" src="<?php echo base_url('front_assets/img/art/img2.jpg') ?>" alt="">
                                        <div class="overlay">
