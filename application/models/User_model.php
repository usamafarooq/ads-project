...
class User_model extends MY_Model
{
	...
	{
		$this->db->select('u.*,ut.name as role, pp.name as package, pp.Amount as package_amount, pu.pricing_plan_id, pp.Click_Price, pp.Refer_Click_Price, pp.Daily_Ads, approve_amount, pending_amount')
				 ->from('users u')
